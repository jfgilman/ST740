...
PLPMCMC <- function(data, samples = 40000, shapePriorA = .001,
  ...
  logPost <- function(parm, d) {
    ...
    for(k in 6:length(parm)){
      ...
      lp <- lp + 
        logPLPSum(d[[k-5]]$totalMiles[which(d[[k-5]]$Censor == 0 & d[[k-5]]$Phase == 1 & d[[k-5]]$trun == F)], parm[3], parm[k]) +
        logPLPSum(d[[k-5]]$totalMiles[which(d[[k-5]]$Censor == 0 & d[[k-5]]$Phase == 2 & d[[k-5]]$trun == F)], parm[3], parm[k]*parm[4]) +
        logPLPSum(d[[k-5]]$totalMiles[which(d[[k-5]]$Censor == 0 & d[[k-5]]$Phase == 3 & d[[k-5]]$trun == F)], parm[3], parm[k]*parm[4]*parm[5]) -
        ...
        logPLPInterval(d[[k-5]]$Lower[which(d[[k-5]]$Phase == 1 & d[[k-5]]$trun == T)], d[[k-5]]$Upper[which(d[[k-5]]$Phase == 1 & d[[k-5]]$trun == T)], parm[3], parm[k]) +
        logPLPInterval(d[[k-5]]$Lower[which(d[[k-5]]$Phase == 2 & d[[k-5]]$trun == T)], d[[k-5]]$Upper[which(d[[k-5]]$Phase == 2 & d[[k-5]]$trun == T)], parm[3], parm[k]*parm[4]) +
                           ...
                           sum(data[[j-5]]$totalMiles[which(data[[j-5]]$Phase == 1 & data[[j-5]]$Censor == 1 & data[[j-5]]$trun == F)]^draws[i-1,3],
                             ...
                             sum(data[[j-5]]$Upper[which(data[[j-5]]$Phase == 1 & data[[j-5]]$trun == T)]^draws[i-1,3] - 
                                 ...
                                 draws[i-1,4] * (data[[j-5]]$Upper[which(data[[j-5]]$Phase == 2 & data[[j-5]]$trun == T)]^draws[i-1,3] - 
                                   data[[j-5]]$Lower[which(data[[j-5]]$Phase == 2 & data[[j-5]]$trun == T)]^draws[i-1,3]),
                                 draws[i-1,4] * draws[i-1,5] *(data[[j-5]]$Upper[which(data[[j-5]]$Phase == 3 & data[[j-5]]$trun == T)]^draws[i-1,3] - 
  ...
  for(i in 1:nrow(finalDraws)){
    for(j in 6:ncol(finalDraws)){
      d[i] <- d[i] - 
        2*(logPLPSum(data[[j-5]]$totalMiles[which(data[[j-5]]$Censor == 0 & data[[j-5]]$Phase == 1 & data[[j-5]]$trun == F)], finalDraws[i,3], finalDraws[i,j]) +
             logPLPSum(data[[j-5]]$totalMiles[which(data[[j-5]]$Censor == 0 & data[[j-5]]$Phase == 2 & data[[j-5]]$trun == F)], finalDraws[i,3], finalDraws[i,j]*finalDraws[i,4]) +
             logPLPSum(data[[j-5]]$totalMiles[which(data[[j-5]]$Censor == 0 & data[[j-5]]$Phase == 3 & data[[j-5]]$trun == F)], finalDraws[i,3], finalDraws[i,j]*finalDraws[i,4]*finalDraws[i,5]) -
             ...
             logPLPInterval(data[[j-5]]$Lower[which(data[[j-5]]$Phase == 1 & data[[j-5]]$trun == T)], data[[j-5]]$Upper[which(data[[j-5]]$Phase == 1 & data[[j-5]]$trun == T)], finalDraws[i,3], finalDraws[i,j]) +
             logPLPInterval(data[[j-5]]$Lower[which(data[[j-5]]$Phase == 2 & data[[j-5]]$trun == T)], data[[j-5]]$Upper[which(data[[j-5]]$Phase == 2 & data[[j-5]]$trun == T)], finalDraws[i,3], finalDraws[i,j]*finalDraws[i,4]) +
             logPLPInterval(data[[j-5]]$Lower[which(data[[j-5]]$Phase == 3 & data[[j-5]]$trun == T)], data[[j-5]]$Upper[which(data[[j-5]]$Phase == 3 & data[[j-5]]$trun == T)], finalDraws[i,3], finalDraws[i,j]*finalDraws[i,4]*finalDraws[i,5]))
    }
  }
  ...
  dthetahat <- 0
  for(j in 6:ncol(finalDraws)){
    dthetahat <- dthetahat - 2*(logPLPSum(data[[j-5]]$totalMiles[which(data[[j-5]]$Censor == 0 & data[[j-5]]$Phase == 1 & data[[j-5]]$trun == F)], mean(finalDraws[,3]), mean(finalDraws[,j])) +
                                  logPLPSum(data[[j-5]]$totalMiles[which(data[[j-5]]$Censor == 0 & data[[j-5]]$Phase == 2 & data[[j-5]]$trun == F)], mean(finalDraws[,3]), mean(finalDraws[,j])*mean(finalDraws[,4])) +
                                  logPLPSum(data[[j-5]]$totalMiles[which(data[[j-5]]$Censor == 0 & data[[j-5]]$Phase == 3 & data[[j-5]]$trun == F)], mean(finalDraws[,3]), mean(finalDraws[,j])*mean(finalDraws[,4])*mean(finalDraws[,5])) -
                                  ...
                                  logPLPInterval(data[[j-5]]$Lower[which(data[[j-5]]$Phase == 1 & data[[j-5]]$trun == T)], data[[j-5]]$Upper[which(data[[j-5]]$Phase == 1 & data[[j-5]]$trun == T)], mean(finalDraws[,3]), mean(finalDraws[,j])) +
                                  logPLPInterval(data[[j-5]]$Lower[which(data[[j-5]]$Phase == 2 & data[[j-5]]$trun == T)], data[[j-5]]$Upper[which(data[[j-5]]$Phase == 2 & data[[j-5]]$trun == T)], mean(finalDraws[,3]), mean(finalDraws[,j])*mean(finalDraws[,4])) +
                                  logPLPInterval(data[[j-5]]$Lower[which(data[[j-5]]$Phase == 3 & data[[j-5]]$trun == T)], data[[j-5]]$Upper[which(data[[j-5]]$Phase == 3 & data[[j-5]]$trun == T)], mean(finalDraws[,3]), mean(finalDraws[,j])*mean(finalDraws[,4])*mean(finalDraws[,5])))
  }
