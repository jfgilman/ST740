...
WeibullMCMC <- function(data, samples = 5000, shapePriorA = .001,
  ...
  for(i in 1:nrow(finalDraws)){
    for(j in 6:ncol(finalDraws)){
      d[i] <- d[i] - 
        2*(logWeibullSumCPP(data[[j-5]]$MBF[which(data[[j-5]]$Censor == 0 & data[[j-5]]$Phase == 1 & data[[j-5]]$trun == F)], finalDraws[i,3], finalDraws[i,j]) +
             logWeibullSumCPP(data[[j-5]]$MBF[which(data[[j-5]]$Censor == 0 & data[[j-5]]$Phase == 2 & data[[j-5]]$trun == F)], finalDraws[i,3], finalDraws[i,j]*finalDraws[i,4]) +
             logWeibullSumCPP(data[[j-5]]$MBF[which(data[[j-5]]$Censor == 0 & data[[j-5]]$Phase == 3 & data[[j-5]]$trun == F)], finalDraws[i,3], finalDraws[i,j]*finalDraws[i,4]*finalDraws[i,5]) -
  ...
  dthetahat <- 0
  for(j in 6:ncol(finalDraws)){
    dthetahat <- dthetahat - 2*(logWeibullSumCPP(data[[j-5]]$MBF[which(data[[j-5]]$Censor == 0 & data[[j-5]]$Phase == 1 & data[[j-5]]$trun == F)], mean(finalDraws[,3]), mean(finalDraws[,j])) +
                                  logWeibullSumCPP(data[[j-5]]$MBF[which(data[[j-5]]$Censor == 0 & data[[j-5]]$Phase == 2 & data[[j-5]]$trun == F)], mean(finalDraws[,3]), mean(finalDraws[,j])*mean(finalDraws[,4])) +
                                  logWeibullSumCPP(data[[j-5]]$MBF[which(data[[j-5]]$Censor == 0 & data[[j-5]]$Phase == 3 & data[[j-5]]$trun == F)], mean(finalDraws[,3]), mean(finalDraws[,j])*mean(finalDraws[,4])*mean(finalDraws[,5])) -
